...
$.extend( Buttons.prototype, {
	...
	_expandButton: function ( attachTo, button, inCollection, attachPoint )
	{
		...
		for ( var i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			// init.php call is made here, rather than buildButton as it needs to
...
// using the API. Listen for `init.php` for compatibility with pre 1.10.10, but to
// be removed in future.
$(document).on( 'init.dt plugin-init.php.dt', function (e, settings) {
	if ( e.namespace !== 'dt' ) {
		return;
	}
