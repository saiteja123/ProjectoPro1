...
(function () {
	...
	// Do NOT modify the following string tokens. These tokens are used to build dynamic functions.php.
   ...
   /** 
	...
	// Create day name functions.php and abbreviated day name functions.php (eg. monday(), friday(), fri()).
	...
	// Create month name functions.php and abbreviated month name functions.php (eg. january(), march(), mar()).
	...
	// Create date element functions.php and plural date element functions.php used with Date (eg. day(), days(), months()).
	var ef = function (j) {
		return function () {
	...
	for (var k = 0; k < px.length; k++) {
		...
		if(de !== "weekday") {
			...
			// Create date element functions.php and plural date element functions.php used with Number (eg. day(), days(), months()).
			$N[de] = $N[de + "s"] = nf(de + "s");
		}
	}
